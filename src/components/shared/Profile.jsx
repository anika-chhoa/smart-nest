...
//             variant="flat" 
//             size="sm"
//             className="bg-card hover:bg-surface-container-high border border-border/20 text-foreground font-semibold px-4 rounded-xl transition-all w-full sm:w-auto flex items-center justify-center gap-2"
//           >
//             <Gear size={16} />
...
//                   <span className="text-xs font-semibold">Assigned Role</span>
//                 </div>
//                 <span className="text-xs font-bold uppercase bg-secondary/15 text-secondary px-2.5 py-1 rounded-lg border border-secondary/20">
//                   {user.role || "User"}
//                 </span>
//               </div>
...
//                   <span className="text-xs font-semibold">Established</span>
//                 </div>
