...
//                       Review schedule windows and verification data entries
//                       below.
//                     </p>
//                   </div>
//                 </div>
...
//                   <form id="booking-modal-form" className="flex flex-col gap-5">
...
//                         <User size={13} className="text-muted" /> User Info /
//                         Full Name
//                       </Label>
//                       <Input
...
//                     >
//                       <Label className="font-body text-xs font-bold text-primary uppercase tracking-wide flex items-center gap-1.5 mb-1">
//                         <FileText size={13} className="text-muted" /> Additional
//                         Notes
//                       </Label>
//                       <Input
...
//                   variant="secondary"
//                   className="rounded-xl font-body font-medium mt-12 text-xs cursor-pointer border border-border"
//                 >
//                   Cancel
//                 </Button>
    ...
    <div className="w-full min-h-screen bg-background pb-16">
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 font-heading text-lg sm:text-xl md:text-2xl text-primary font-bold">
                ...
                <span className="whitespace-nowrap">{Number(property.size || 0).toLocaleString()} Sqft</span>
              </div>
            </div>
          </motion.div>
      ...
      <AnimatePresence>
        {isModalOpen && (
          <Modal isOpen={isModalOpen} onOpenChange={setIsModalOpen}>
            <Modal.Backdrop>
              <Modal.Container placement="center" className="p-4 sm:p-6 max-w-lg w-full mx-auto">
                <motion.div
                ...
                >
                  <Modal.Dialog className="w-full rounded-2xl overflow-hidden border border-border/60 bg-background shadow-2xl">
                    ...
                    <Modal.Body className="p-5 sm:p-6 max-h-[60vh] overflow-y-auto custom-scrollbar">
                      <Surface variant="default">
                        <form id="booking-modal-form" className="flex flex-col gap-4 sm:gap-5">
                          {/* User Profile Info Context Field */}
                          <TextField
                            className="w-full"
                            name="userInfo"
                    ...
                    <Modal.Footer className="bg-surface-container-low p-4 px-5 sm:px-6 border-t border-border/20 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-3">
                      ...
                      <form action={"/api/checkout_session"} method="POST" className="w-full sm:w-auto">
                        {/* property information */}
                        <input type="hidden" name="title" value={property.title} readOnly />
                        <input type="hidden" name="location" value={property.location} readOnly />
                        <input type="hidden" name="price" value={property.rentPrice} readOnly />
                        <input type="hidden" name="image" value={property.images} readOnly />
                        <input type="hidden" name="rentType" value={property.rentType} readOnly />
                        <input type="hidden" name="propertyId" value={property._id} readOnly />

                        {/* modal information */}
                        <input type="hidden" name="userInfo" value={userInfo} readOnly />
                        <input type="hidden" name="moveInDate" value={moveInDate} readOnly />
                        <input type="hidden" name="contactNumber" value={contactNumber} readOnly />
                        <input type="hidden" name="additionalNotes" value={additionalNotes} readOnly />
